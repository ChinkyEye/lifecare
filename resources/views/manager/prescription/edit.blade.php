  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6 pl-1">
        <h1 class="text-capitalize">Update {{ $page }}</h1>
      </div>
      <div class="col-sm-6">
...
<section class="content">
  <div class="card card-info">
    <form role="form" method="POST" action="{{route('manager.prescription.update', $prescriptions->id)}}" enctype="multipart/form-data">
      <div class="card-body">
      	@method('PATCH')
        @csrf
        <div class="form-group">
          ...
          <select class="form-control" name="doctor_id" id="doctor_id">
            ...
            <option value="{{ $doctor->id }}" {{ $doctor->id == $prescriptions->doctor_id ? 'selected' : ''}}>
              {{$doctor->name}}
            </option>
            @endforeach
          </select>
         ...
         <div class="form-group">
          ...
          <input type="text" class="form-control max" name="examination_mse" value="{{$prescriptions->examination_mse}}" autocomplete="off" autofocus value="{{ old('examination_mse') }}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control max" name="clinical_note" value="{{$prescriptions->clinical_note}}" autocomplete="off" autofocus value="{{ old('clinical_note') }}">
          @error('clinical_note')
          <span class="text-danger font-italic" role="alert">
            <strong>{{ $message }}</strong>
          </span>

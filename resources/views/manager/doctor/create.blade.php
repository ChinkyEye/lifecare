    ...
    <form role="form" method="POST" action="{{route('manager.doctor.store')}}" enctype="multipart/form-data">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <textarea class="ckeditor form-control" rows="10" cols="20" name="experience" placeholder="Enter Details....."></textarea>
          @error('experience')
          <span class="text-danger font-italic" role="alert">
            <strong>{{ $message }}</strong>
          </span>
        ...
        <div class="form-group">
          ...
          <input type="text"  class="form-control max" id="nmc_no" placeholder="Enter nmc no" name="nmc_no" autocomplete="off" autofocus value="{{ old('nmc_no') }}">
          @error('nmc_no')
          <span class="text-danger font-italic" role="alert">
            <strong>{{ $message }}</strong>
          </span>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="qualification" rows="3" name="qualification" placeholder="Write something here..." value="{{ old('qualification') }}"></textarea>
